 ...
 */
public class ArithmeticAddComposite implements IArithmeticComponent
{

    private List<IArithmeticComponent> componentList;

    public ArithmeticAddComposite() {   this.componentList = new ArrayList<IArithmeticComponent>(); }
