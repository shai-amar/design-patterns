 ...
 */
public class ArithmeticMultiplyComposite implements IArithmeticComponent
{

    private List<IArithmeticComponent> componentList;

    public ArithmeticMultiplyComposite()
    {
        this.componentList = new ArrayList<IArithmeticComponent>();
    }
